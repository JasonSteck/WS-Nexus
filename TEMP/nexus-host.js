class NexusHost {
  constructor(nexusServer, hostName, disableDefaultCallbacks=false) {
  ...
  send(message, clientIDs=undefined) {
  ...
  close(code=1000, reason="Host closed their connection") {
    ...
    //     console.log('Received:', event.data);
      ...
      switch(req.type) {
        ...
        case 'FROM_CLIENT':
          ...
          break;
        case 'LOST_CLIENT':
          this.onClientLost && this.onClientLost(req.clientID);
          break;
        case 'REGISTERED':
          this.id = req.hostID;
